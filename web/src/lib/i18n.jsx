...
const en = {
  ...
  'hero.titleA': 'Your health records go',
  'hero.titleB': 'wherever you go',
  'hero.lede': 'Beral Care brings patients and doctors together, on a computer, a smartphone, or a basic phone. You keep your own health records, and you decide which doctor can see them.',
  'hero.cta': 'Create a free account',
  'hero.proof1': 'Ways to connect',
  'hero.proof2': 'Health assistants',
  'hero.proof3': 'You control access',
...
const fr = {
  ...
  'hero.titleA': 'Vos dossiers de santé vous suivent',
  'hero.titleB': 'partout où vous allez',
  'hero.lede': 'Beral Care réunit les patients et les médecins, sur un ordinateur, un smartphone ou un téléphone simple. Vous gardez vos propres dossiers de santé, et vous décidez quel médecin peut les consulter.',
  'hero.cta': 'Créer un compte gratuit',
  'hero.proof1': 'Façons de se connecter',
  'hero.proof2': 'Assistants santé',
  'hero.proof3': 'Vous contrôlez l’accès',
